...
from ..models.specifications import (
    ...
    WorkflowType,
    DetailedAgentSpec,
    DetailedWorkflowSpec,
    DetailedToolSpec,
    DetailedModelConfigSpec
)
...
class SpecificationValidator:
    ...
    def _load_schemas(self):
        ...
        self.schemas = {
            "AgentSpec": {"type": "object", "required": ["apiVersion", "kind", "metadata", "spec"]},
            "WorkflowTemplate": {"type": "object", "required": ["apiVersion", "kind", "metadata", "spec"]},
            "ToolSpec": {"type": "object", "required": ["apiVersion", "kind", "metadata", "spec"]},
            "ModelConfig": {"type": "object", "required": ["apiVersion", "kind", "metadata", "spec"]}
        }
    ...
    def _validate_workflow_agent(self, agent_config: Dict[str, Any], agent_spec: Dict[str, Any]):
    ...
    def _validate_loop_agent(self, agent_config: Dict[str, Any], agent_spec: Dict[str, Any]):
